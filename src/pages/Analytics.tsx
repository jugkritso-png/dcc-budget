  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 tracking-tight">วิเคราะห์ข้อมูล (Analytics)</h2>
          <p className="text-gray-500 mt-2">รายงานเชิงลึกและแนวโน้มการใช้จ่ายงบประมาณ</p>
        </div>

        {/* Tab Navigation */}
        <div className="bg-gray-100/80 p-1.5 rounded-xl flex shadow-inner border border-gray-200/50 backdrop-blur-sm">
          <button
