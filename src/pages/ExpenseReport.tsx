...
const ExpenseReport: React.FC = () => {
    const { requests, user, submitExpenseReport, completeRequest, revertComplete } = useBudget();
    ...
    const handleVerifyParams = async (request: BudgetRequest) => {
        if (!confirm(`ยืนยันการตรวจสอบและปิดโครงการ "${request.project}"?\nระบบจะทำการคืนเงินงบประมาณเข้าสู่หมวดรายจ่ายทันที`)) return;
        try {
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="border-t border-gray-100 pt-4 mt-4 flex justify-between items-center">
                                    ...
                                    {viewMode === 'verify' && (
                                        <Button
                                            onClick={() => handleVerifyParams(req)}
