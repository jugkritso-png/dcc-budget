...
import SettingsGeneral from '@/components/features/SettingsGeneral';
import SettingsProfile from '@/components/features/SettingsProfile';
import SettingsPolicies from '@/components/features/SettingsPolicies';
import SettingsDepartments from '@/components/features/SettingsDepartments';
import SettingsUsers from '@/components/features/SettingsUsers';
import SettingsNotifications from '@/components/features/SettingsNotifications';
import SettingsBackup from '@/components/features/SettingsBackup';
import SettingsActivityLogs from '@/components/features/SettingsActivityLogs';
import SettingsAppearance from '@/components/features/SettingsAppearance';
import { Building, User, AlertCircle, Database, Users, Bell, Download, Lock, History, Palette, Shield } from 'lucide-react';
import { Card } from '@/components/ui/Card';

import SettingsPermissions from '@/components/features/SettingsPermissions';
