        ...
        <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 p-6 md:p-10 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div className="flex items-center gap-4">
                    <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight">รายการหมวดหมู่</h3>
                    <select value={selectedYear} onChange={(e) => onYearChange(Number(e.target.value))} className="bg-gray-50 text-gray-700 px-4 py-2.5 rounded-[12px] text-sm font-bold border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 cursor-pointer hover:bg-gray-100 transition-colors">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <div className="relative w-full md:w-72">
                        ...
                        <input type="text" value={searchQuery} onChange={(e) => onSearchChange(e.target.value)} placeholder="ค้นหาหมวดหมู่..." className="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-[12px] text-sm focus:ring-2 focus:ring-[#0066B3] focus:border-transparent transition-all outline-none" />
                    </div>
                    <button onClick={onAddClick} className="bg-gradient-to-r from-[#00A1E4] to-[#0066B3] text-white px-6 py-2.5 rounded-[12px] text-sm font-bold hover:shadow-lg flex items-center gap-2 whitespace-nowrap transition-transform hover:-translate-y-0.5">
