...
const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  const percent =
    category.allocated > 0 ? (category.used / category.allocated) * 100 : 0;
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] font-bold text-gray-500 bg-gray-100 px-2.5 py-1 rounded-lg border border-gray-200 group-hover:border-primary-200 group-hover:bg-primary-50 group-hover:text-primary-600 transition-colors">
                {category.code}
              </span>
            </div>
      ...
      <td className="py-5 text-right font-bold text-gray-700 align-middle text-lg bg-white group-hover:bg-blue-50/30">
