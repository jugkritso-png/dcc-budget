    ...
    return (
        <div className="p-4 md:p-8 h-full flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="max-w-md w-full bg-white p-8 rounded-[24px] shadow-sm hover:shadow-card transition-shadow duration-300 border border-gray-100">
                ...
                <h3 className="text-xl font-extrabold text-gray-900 mb-2 tracking-tight">สำรองข้อมูล (Backup)</h3>
                <p className="text-gray-500 text-sm mb-8 font-medium">ดาวน์โหลดข้อมูลทั้งหมดของระบบเก็บไว้ในรูปแบบไฟล์ JSON เพื่อความปลอดภัย</p>

                <div className="mb-6 p-5 bg-[#F4F6F9] rounded-[16px] text-left border border-gray-100">
                    <p className="text-xs text-gray-500 mb-1 font-medium">Backup ล่าสุด</p>
                    <p className="text-sm font-bold text-gray-900">{lastBackup || 'ยังไม่เคยสำรองข้อมูล'}</p>
                </div>
