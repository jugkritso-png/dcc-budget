      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm mt-1">
              ตั้งค่าข้อมูลพื้นฐานของหน่วยงานและการแสดงผลเอกสาร
            </p>
          </div>
          <Button
            onClick={handleSave}
        ...
        <div className="bg-white rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden relative">
          ...
          <div className="relative h-48 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-[#00A1E4] via-[#0066B3] to-[#003964]"></div>
            ...
            <div className="absolute bottom-6 left-8 flex items-end gap-6 z-10">
              <div className="w-16 h-16 md:w-24 md:h-24 bg-white rounded-[24px] shadow-xl flex items-center justify-center text-[#0066B3] border-4 border-white/50 backdrop-blur-md">
                <Landmark size={32} className="md:w-12 md:h-12" />
              </div>
              <div className="pb-2">
                <h3 className="text-2xl font-bold text-white drop-shadow-md">
                  {formData.orgName || "ชื่อหน่วยงาน"}
                </h3>
          ...
          <div className="p-8 pt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
              ...
              {/* Info Card */}
              <div className="bg-[#00A1E4]/5 rounded-[24px] p-6 border border-[#00A1E4]/20 flex items-start gap-4">
                <div className="bg-white p-2.5 rounded-xl shadow-sm text-[#0066B3] shrink-0 border border-gray-100">
                  <Landmark size={20} className="stroke-[2.5px]" />
                </div>
                <div>
                  <h4 className="font-bold text-[#0066B3] text-[15px] mb-1.5 tracking-wide">
                    เกี่ยวกับปีงบประมาณ
                  </h4>
                  <p className="text-sm text-gray-600 leading-relaxed font-medium">
                    การเปลี่ยนปีงบประมาณจะมีผลต่อเลขอ้างอิงเอกสารและรายงานสรุปยอดใช้จ่ายทั้งหมดในระบบ
