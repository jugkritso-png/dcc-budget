                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
                            <h3 className="text-xl font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-50 tracking-tight">
                                <div className="p-2.5 bg-blue-50 text-[#0066B3] rounded-xl"><User size={20} className="stroke-[2.5px]" /></div>
                        ...
                        <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
                            <h3 className="text-xl font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-50 tracking-tight">
                                <div className="p-2.5 bg-orange-50 text-[#F57F17] rounded-xl"><Briefcase size={20} className="stroke-[2.5px]" /></div>
                        ...
                        <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
                            <h3 className="text-xl font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-50 tracking-tight">
                                <div className="p-2.5 bg-purple-50 text-purple-600 rounded-xl"><Phone size={20} className="stroke-[2.5px]" /></div>
                        ...
                        <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
                            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-50">
                                <h3 className="text-xl font-extrabold text-gray-900 flex items-center gap-3 tracking-tight">
                                    <div className="p-2.5 bg-rose-50 text-rose-500 rounded-xl"><Lock size={20} className="stroke-[2.5px]" /></div>
