      ...
      <div className="flex flex-col xl:flex-row gap-12 items-start justify-center">
        ...
        <div className="flex flex-col gap-6 sticky top-8 items-center w-full xl:w-auto">
              ...
              <div className="w-full aspect-[2/3.2] rounded-[24px] bg-white shadow-[0_20px_40px_-10px_rgba(0,0,0,0.2)] overflow-hidden relative flex flex-col items-center border border-gray-100">
                ...
                <div className="z-10 w-full px-6 py-7 flex gap-4 items-center shrink-0">
                  ...
                  <div className="flex flex-col justify-center">
                    <span className="text-[#3f1052] font-extrabold text-[1.15rem] leading-none tracking-tight">
                      มหาวิทยาลัยวลัยลักษณ์
                    </span>
                    <span className="text-[#591b6e] font-bold text-[0.65rem] tracking-[0.08em] uppercase mt-1 opacity-90">
                      WALAILAK UNIVERSITY
                    </span>
                  </div>
                </div>
                ...
                <div className="relative w-full px-8 mt-1 flex flex-col items-end z-10 shrink-0">
                  ...
                  <div className="w-full text-right px-1">
                    <span className="text-[#F57F17] font-bold text-lg tracking-wider font-mono drop-shadow-[0_1px_1px_rgba(255,255,255,1)]">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-400 mt-2">
              คลิกที่รูปภาพบนบัตรเพื่อเปลี่ยนรูปโปรไฟล์
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-6 w-full max-w-2xl">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
              <h3 className="text-xl font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-50 tracking-tight">
                <div className="p-2.5 bg-blue-50 text-[#0066B3] rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700">
                    ชื่อ-นามสกุล (TH) <span className="text-red-500">*</span>
                  </label>
                  <Input
                    type="text"
            ...
            <div className="bg-white border border-gray-100 shadow-sm hover:shadow-card transition-all duration-300 rounded-[24px] p-6 md:p-8">
              <h3 className="text-xl font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-50 tracking-tight">
                <div className="p-2.5 bg-orange-50 text-[#F57F17] rounded-xl">
