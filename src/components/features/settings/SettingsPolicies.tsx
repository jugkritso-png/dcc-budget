        ...
        <div className="p-6 md:p-8 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                    <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight">นโยบายงบประมาณ</h3>
                ...
                <div className="flex flex-col justify-between p-6 md:p-8 bg-white border border-gray-100 rounded-[24px] shadow-sm hover:shadow-card transition-all duration-300 gap-4 group">
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            <h4 className="text-lg font-bold text-gray-900 group-hover:text-[#0066B3] transition-colors">แจ้งเตือนงบเกิน</h4>
                        ...
                        <p className="text-sm text-gray-500 leading-relaxed font-medium">ระบบจะแจ้งเตือนเมื่อมีการขออนุมัติเกินวงเงินคงเหลือ แต่ยังสามารถบันทึกได้</p>
                    </div>
                </div>

                <div className="flex flex-col justify-between p-6 md:p-8 bg-white border border-gray-100 rounded-[24px] shadow-sm hover:shadow-card transition-all duration-300 gap-4 group">
                    <div>
                        <h4 className="text-lg font-bold text-gray-900 mb-4 group-hover:text-[#0066B3] transition-colors">วันปิดงบประมาณ</h4>
                        ...
                        <p className="text-sm text-gray-500 mt-4 font-medium">กำหนดวันสุดท้ายที่อนุญาตให้ส่งคำขอสำหรับปีงบประมาณนี้</p>
                    </div>
                </div>
            </div>
        </div>
