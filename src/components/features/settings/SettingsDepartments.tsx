            ...
            <div className="max-w-5xl mx-auto w-full flex flex-col h-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 shrink-0">
                    <div className="text-center md:text-left">
                        <h2 className="text-2xl font-extrabold text-gray-900 flex items-center justify-center md:justify-start gap-3 tracking-tight">
                            <div className="p-2.5 bg-[#00A1E4]/10 rounded-[16px] text-[#0066B3]">
                                <LayoutGrid size={24} className="stroke-[2.5px]" />
                            </div>
                            จัดการหน่วยงาน
                        </h2>
                        <p className="text-gray-500 text-sm mt-2 md:ml-[60px] text-center md:text-left font-medium">
                            มีทั้งหมด <span className="text-[#0066B3] font-bold bg-[#00A1E4]/10 px-2 py-0.5 rounded-md">{departments?.length || 0}</span> หน่วยงานในระบบ
                        </p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto pr-2 -mr-2 pb-12">
                    <AnimatePresence mode="popLayout">
                        {isAddMode && (
                            ...
                            >
                                <div className="bg-white/80 backdrop-blur-xl rounded-[24px] p-6 shadow-card border border-gray-100 relative overflow-hidden group">
                                    <div className="absolute top-0 right-0 w-48 h-48 bg-[#00A1E4]/10 rounded-full blur-3xl -z-10 translate-x-1/2 -translate-y-1/2"></div>
                                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#0066B3]/5 rounded-full blur-2xl -z-10 -translate-x-1/2 translate-y-1/2"></div>

                                    <div className="flex justify-between items-center mb-6">
                                        <h3 className="font-extrabold text-xl text-gray-900 flex items-center gap-3 tracking-tight">
                                            <div className="w-10 h-10 rounded-xl bg-[#00A1E4]/10 text-[#0066B3] flex items-center justify-center">
                                                <Plus size={20} className="stroke-[2.5px]" />
                                            </div>
                                            สร้างหน่วยงานใหม่
                                        </h3>
                                        <Button variant="ghost" size="sm" onClick={() => setIsAddMode(false)} className="text-gray-400 hover:text-gray-800 p-2 hover:bg-gray-100 rounded-full transition-colors">
                                            <X size={20} />
                                        </Button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                        ...
                                        <div className="md:col-span-2 space-y-2">
                                            ...
                                            <div className="relative h-[48px] w-full rounded-xl overflow-hidden border border-gray-200 shadow-sm transition-transform hover:scale-[1.02]">
                                                ...
                                                />
                                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none mix-blend-difference text-white font-mono text-xs uppercase font-bold">
                                                    {newDept.color}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="shrink-0 flex items-center md:block gap-3 w-full md:w-auto">
                                            ...
                                            {editingId === dept.id && editRowData ? (
                                                ...
                                                <div className="w-14 h-14 rounded-2xl bg-gray-50 border border-gray-100 flex flex-col items-center justify-center text-gray-500 font-mono text-sm font-bold shadow-sm group-hover:shadow-inner group-hover:bg-white transition-all">
                                                    <span className="text-[10px] uppercase text-gray-400 font-medium mb-0.5">Code</span>
                                                    {dept.code}
                                                </div>
                                            )}
                                        </div>
