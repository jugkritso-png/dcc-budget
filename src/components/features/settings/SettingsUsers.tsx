                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 shrink-0">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-500 text-sm mt-2 md:ml-[60px] text-center md:text-left font-medium">
                            บริหารจัดการบัญชีผู้ใช้งานและสิทธิ์การเข้าถึงทั้งหมด <span className="text-[#0066B3] font-bold bg-[#00A1E4]/10 px-2 py-0.5 rounded-md">{users.length}</span> บัญชี
                        </p>
                    </div>
                                ...
                                {filteredUsers.map((user, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-5 mb-6">
                                            <div className={`w-14 h-14 rounded-[16px] flex items-center justify-center text-xl font-bold shadow-sm overflow-hidden shrink-0 ${user.role === 'admin' ? 'bg-gradient-to-br from-[#00A1E4] to-[#0066B3] text-white' :
                                            ...
                                            <div className="min-w-0">
                                                <h4 className="text-lg font-bold text-gray-900 group-hover:text-[#0066B3] transition-colors truncate">{user.name}</h4>
                                                <p className="text-xs text-gray-500 font-mono bg-gray-50 px-2 py-1 rounded-md border border-gray-100 inline-block mt-1.5 max-w-full truncate">@{user.username}</p>
                                            </div>
                                        </div>
