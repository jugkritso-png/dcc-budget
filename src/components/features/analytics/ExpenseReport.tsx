...
const ExpenseReport: React.FC = () => {
    const { requests, user, submitExpenseReport, completeRequest, revertComplete, rejectExpenseReport, uploadAttachment } = useBudget();
                ...
                <div className="space-y-6">
                    ...
                    <div className="border-t border-gray-100 pt-6 mt-6">
                        ...
                        <div className="bg-gray-50 rounded-xl border border-gray-200 border-dashed p-4">
                            ...
                            />
                            <label htmlFor="expense-file-upload" className="cursor-pointer flex flex-col items-center justify-center space-y-1 text-gray-400 hover:text-primary-600 transition-colors py-4">
                                <Plus size={24} className="mb-1" />
                                <span className="text-xs font-semibold">คลิกเพื่อเพิ่มไฟล์ใบเสร็จ</span>
                            ...
                            {selectedFiles.length > 0 && (
                                <div className="mt-4 space-y-2">
                                    {selectedFiles.map((file, idx) => (
                                        <div key={idx} className="flex items-center justify-between text-xs bg-white p-2 rounded-lg border border-gray-100 shadow-sm">
                                            <span className="truncate max-w-[80%] font-medium text-gray-600">{file.name}</span>
                                            <button
                            ...
                            {selectedRequest?.attachments && selectedRequest.attachments.length > 0 && (
                                <div className="mt-4 pt-4 border-t border-gray-100">
                                    <p className="text-[10px] uppercase tracking-wider text-gray-400 font-bold mb-2">ไฟล์เดิมที่แนบทมา:</p>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex flex-col gap-3">
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-gray-500 font-medium tracking-tight uppercase text-[11px]">เอกสารแนบทั้งหมด ( All Attachments )</span>
                                ...
                                {selectedRequest.attachments.map((url, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <span className="text-xs font-bold text-gray-700 truncate">เอกสารแนบที่ {idx + 1}</span>
                                            <span className="text-[10px] text-gray-400 truncate">คลิกเพื่อดูไฟล์</span>
                                        </div>
                                    </a>
                                ))}
                            </div>
