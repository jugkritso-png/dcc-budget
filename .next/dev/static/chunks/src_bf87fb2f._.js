...
const ExpenseReport = ()=>{
    _s();
    const { requests, user, submitExpenseReport, completeRequest, revertComplete, rejectExpenseReport } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$BudgetContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBudget"])();
...
_s(ExpenseReport, "NRJjKN74YfJcOZb6DtHfgO0K6bw=", false, function() {
    return [
